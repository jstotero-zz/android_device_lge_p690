...
PRODUCT_COPY_FILES += \\
    vendor/__Vb/libgstk_exp.so:system/lib/libgstk_exp.so \\
    ...
    vendor/__VENDOR__/__DEVICE__/proprietary/bin/atd:system/birn/__VENDOR__/__DEVICE__/proprietary/bin/atd:system/bin/atd
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/__VENDOR__/__DEVICE__/proprietary/etc/firmware/wlan/cfg.dat:system/etc/firmware/wlan/cfg.dat \\
    vendor/__VENDOR__/__DEVICE__/proprietary/etc/firmware/wlan/qcom_fw.bin:system/etc/firmware/wlan/qcom_fw.bin
